<form action="<?php echo $action; ?>" method="post">
  ...
  <div class="buttons">
      ...
      <div class="pull-right"> <input type="submit" id="button-confirm" value="<?php echo $button_confirm; ?>" class="button btn btn-primary" />
    </div>
  </div>
</form>
...
$('#button-confirm').bind('click', function() {
	$.ajax({
		url: 'index.php?route=payment/bitspay/processorder',
		type: 'post',
		data: $('#payment :input'),
		dataType: 'json',		
		beforeSend: function() {
